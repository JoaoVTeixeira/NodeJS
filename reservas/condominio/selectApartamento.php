   ...
   <header>
    ...
    <main id="content">
        ...
        <div id="formulario">
            <form method="GET">
                <br>
                <label>Numero Apartamento:</label><input type="text" name="numero" id="numero" value="<?php if(isset($_GET['numero'])){ $_GET['numero'];} ?>"><br><br>
                <label>Area Apartamento: </label><input type="text" name="area" id="area" value="<?php if(isset($_GET['area'])){ $_GET['area'];} ?>"><br><br>
